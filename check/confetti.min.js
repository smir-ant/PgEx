var Confetti = function () {
    ...
    var e = function () {
        function e(n) {
            ...
            // New method to trigger burst programmatically
            ...
            this.update = function (t) {
                ...
                for (var e = r.bursts.length - 1; e >= 0; e--) {
                    ...
                    if (0 == r.bursts[e].particles.length) {
                        r.bursts.splice(e, 1);
                    }
                }
                r.draw();
    ...
    var i = function () {
        ...
        t.prototype.update = function (t) {
            for (var e = this.particles.length - 1; e >= 0; e--) {
                ...
                if (this.particles[e].checkBounds()) {
    ...
    var n = function () {
        function t(t) {
            ...
            this.velocity = r.generateVelocity(this.position);
    ...
    var r = function () {
        function t() { }
        t.generateVelocity = function (pos) {
            var t = Math.random() - .5;
            var i = Math.random() - .7;

            // Bias based on position if provided
            if (pos) {
                // Horizontal bias
                if (pos.x < window.innerWidth / 2) {
                    // Left side -> shoot right
                    t = Math.abs(t);
                } else {
                    // Right side -> shoot left
                    t = -Math.abs(t);
                }

                // Vertical bias
                if (pos.y > window.innerHeight / 2) {
                    // Bottom side -> shoot up
                    i = -Math.abs(Math.random()) - 0.5; // Stronger up bias
                }
            }
            ...
            i /= n;
            t /= n;
            return new o(t * (Math.random() * e.CONFIG.explosion_power), i * (Math.random() * e.CONFIG.explosion_power));
        };
        return t;
    }();
    var s = function () {
        ...
        t.clearScreen = function () {
            if (e.CTX) e.CTX.clearRect(0, 0, 2 * window.innerWidth, 2 * window.innerHeight);
        };
